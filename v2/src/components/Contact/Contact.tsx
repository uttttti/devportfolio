...
const Contact: React.FC = () => (
  <div className="Contact" data-testid="Contact" id="Contact">
    ...
    <IconButton href="https://www.facebook.com/uttttti"><FontAwesomeIcon icon={faFacebook} color="#F3E5F5" size="lg"/></IconButton>
    <IconButton href="https://twitter.com/0345"><FontAwesomeIcon icon={faTwitter} color="#F3E5F5" size="lg"/></IconButton>
